            ...
            {discountPercent > 0 && (
              <div className="mt-3 pt-3 border-t border-white/10 space-y-1">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-tourist-coral font-bold">-R$ {(() => {
                    const discountValue = parseFloat(originalValue.replace(',', '.')) * (discountPercent / 100);
                    return formatNumber(discountValue.toFixed(2).replace('.', ','), 'pt-BR');
                  })()}</span>
                </div>
